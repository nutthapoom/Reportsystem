        ...
        <div class="col-md-10 col-sm-10">
            <div class="panel panel-info" id="delay_edit">
                <div class="panel-heading">
                    บันทึก แก้ไข ข้อมูลด้านกิจกรรม
                </div>
                <div class="panel-body">
                  <!-- Text input-->
                  <div class="form-group">
                    <label class="col-md-4 control-label">ชื่อด้านกิจกรรม :</label>
                    ...
                    <div class="table-responsive">
                      ...
                      <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" aria-describedby="dataTables-example_info">
                            ...
                            <tbody>
                              ...
                              ?>
                              <tr>
                                <td class="text-right"><?php echo $row["side_id"]; ?></td>
                                <td class="text-left"><?php echo $row["side_name"]; ?></td>
